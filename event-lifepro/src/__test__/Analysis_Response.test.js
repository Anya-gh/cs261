...
describe("Response class", () => {
    it("constructor and mood calculation", async () => {
        const newResponse = new Response(["It is bad"], Date.now(), 60, "Test Name", "Sitting in the last row", 3);
...
describe("Analysis class", () => {
    ...
    it("calculates mood", async () => {
        const newResponse = new Response(["It is good"], Date.now(), 200, "k_t/zX65", "Sitting in the last row", 9);
        await Response.calculateMood(newResponse);
