...
describe("<Feedback />", () => {
    it("renders without crash", () => {
        render(<Router><Route path="/Feedback/971/User%20Test%201"><Feedback /></Route></Router>);
    });
    /*it("submits", async () => {
        await waitFor(() => render(<Router><Route path="/Feedback/971/User%20Test%201"><Feedback /></Route></Router>));
    ...
    // the component works, but I did not find out how to test it properly
});