...
test("Backend", async () => {
    ...
    await createNewResponse(newEvent.eventID, newUser.userID, [{content: "Black holes", questionID: 0}, {content: "Yes", questionID: 1}], "Backend test name", "University student", 0.9);
